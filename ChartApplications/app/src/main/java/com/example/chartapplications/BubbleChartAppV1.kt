...
import com.example.chartapplications.ui.theme.color11
import com.example.chartapplications.ui.theme.color12
...
@Composable
fun BubbleChartAppV1Screen(navController: NavController) {
    Column() {
